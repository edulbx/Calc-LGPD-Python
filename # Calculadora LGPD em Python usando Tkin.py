# Calculadora LGPD em Python usando Tkinter
...
titulo_label = ttk.Label(container, text="Calculadora de Multas da LGPD", font=("Arial", 14))
...
agravantes_combo = ttk.Combobox(container, values=["1.00", "2.00", "3.00"])
